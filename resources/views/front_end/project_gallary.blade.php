...
<div class="container width-container">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="innerpage-headings">Project Gallery</h1>
            <p class="step-by-step">Home&ensp;<i class="fa fa-caret-right" aria-hidden="true"></i>&ensp;Project&ensp;<i class="fa fa-caret-right" aria-hidden="true"></i>&ensp;<font color="#8A9E43">Project Gallery</font>
            </p>
        </div>
    </div>
