...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-2">
    <br/>
        <a data-toggle="modal" href="#modal-form" class="btn btn-outline btn-success"><i class="fa fa-plus"></i>Add New Type</a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <center><h2 class="m-t-none m-b">New Type</h2></center>

        <form class="form-horizontal" id="create_form" role="form" method="POST" action="{{ route('project_categories.store') }}">
                @csrf
                <div class="form-group" id="err_name">
                    <label>Type Name</label> 
                    <input id="name" type="text" class="form-control" name="name" value="{{ old('title') }}" placeholder="Name" ></div>
        ...
        <div class="ibox float-e-margins">
            ...
            @foreach ($types as $type)
                <tr class="gradeX">
                    ...
                    <td>
                    @permission('edit.project.category')
                        <a href="{{ route('project_categories.edit',$type->id) }}"   class="btn table-action-btn" title="Edit"><i class="fa fa-pencil-square-o"></i> </a> 
                        @endpermission
                        @permission('delete.project.category')
                        <a href="{{ route('project_categories.destroy',$type->id) }}" data-url="" class="btn table-action-btn " title="Delete"> <i class="fa fa-times-circle fa-lg"></i></a>
