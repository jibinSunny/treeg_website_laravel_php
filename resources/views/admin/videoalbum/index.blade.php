...
@section('title', 'Photo Video List')
@section('content')
...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-2 mt-3">
           ...
           <a href="{{ route('video.create') }}" class="pull-right btn btn-outline btn-success modal-open"><i class="fa fa-plus"></i> Add New</a>
            @endpermission
    </div>
</div>
    ...
    <div class="row">
        ...
        <div class="ibox float-e-margins">
          ...
          {{--       <div class="ibox-tools">
            ...
            <tr class="gradeX">
                <td>{{ ($videos->currentpage()-1) * $videos->perpage() + $i + 1 }}</td>
              <td>{{ $video->caption }}</td>
              <td>
                  <iframe width="100" height="75" src="https://www.youtube.com/embed/{{ $video->youtube_video_id }}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

                  <input type="hidden" id="video_id" value="{{ $video->youtube_video_id }}">

              </td>
             
              <td><span class="label label-success">{{ ($video->active==true) ? 'Active': 'Inactive' }}</span></td>
              <td>
      
                  {{-- <a href="/admin/video/{{ $video->id }}/edit" class="btn table-action-btn " title="Edit"><i class="fa fa-pencil-square-o"></i> </a>  --}}
                  @permission('edit.video.album') 
                  <a href=".custom-modal" data-url="{{ route('video.update',$video->id) }}" data-toggle="modal" data-title="Video Update" class="btnEditRow btn table-action-btn modal-open" title="Edit"><i class="fa fa-pencil-square-o"></i> </a> 
                  @endpermission

                  @permission('delete.video.album') 

                  <a href="" data-url="{{ route('video.destroy',$video->id) }}" class="btn table-action-btn btnDeleteRow" title="Delete"> <i class="fa fa-times-circle"></i></a> 
