...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-2">
    <br/>
        <a data-toggle="modal" data-url="{{ route('roles.store') }}" data-title="Add New Permission Role" href=".custom-modal" class="btn btn-outline btn-success"><i class="fa fa-plus"></i> Add New Role</a>
            ...
            @foreach ($roles as $role)
                <tr class="gradeX">
                    ...
                    <td>
                        ...
                        <a href=".custom-modal" data-url="{{ route('roles.edit',$role->id,$role->id) }}" data-toggle="modal" data-title="Role Update" class="btnEditRow btn table-action-btn modal-open" title="Edit"><i class="fa fa-pencil-square-o"></i> </a> 
                        @endpermission
                        @permission('delete.settings')

                        <a href="" data-url="{{ route('roles.destroy',$role->id) }}" class="btn table-action-btn btnDeleteRow" title="Delete"> <i class="fa fa-times-circle fa-lg"></i></a>
