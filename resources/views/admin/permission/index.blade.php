...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-2">
    <br/>
        <a data-toggle="modal" data-url="{{ route('permission.store') }}" data-title="Add New Permission" href=".custom-modal" class="btn btn-outline btn-success"><i class="fa fa-plus"></i> New Permission</a>
        ...
        <form class="form-horizontal" id="create_form" role="form" method="POST" action="">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="checkbox" value="create" name="type[]"> Can Create
                    <input type="checkbox" value="view" class="iCheck" name="type[]"> Can View
                    <input type="checkbox" value="edit" class="iCheck" name="type[]"> Can Edit
                    <input type="checkbox" value="delete" class="iCheck" name="type[]"> Can Delete
                </div>

               {{--  <div class="form-group" id="err_email">
                    <label>Slug</label> 
                    <input id="slug" type="text" class="form-control" name="slug" value="{{ old('slug') }}" placeholder="Slug" >
                </div> --}}

                <div class="form-group" id="err_pass">
            ...
            @foreach ($permissions as $permission)
                <tr class="gradeX">
                    ...
                    <td>
                        ...
                        <a href=".custom-modal" data-url="{{ route('permission.edit',$permission->id) }}" class="btn table-action-btn btnEditRow" title="Edit"><i class="fa fa-pencil-square-o"></i> </a> &nbsp;

                        @endpermission
                        @permission('delete.settings')
                        <a href="" data-url="{{ route('permission.destroy',$permission->id) }}"" class="btn table-action-btn btnDeleteRow" title="Delete"> <i class="fa fa-times-circle fa-lg"></i></a>
